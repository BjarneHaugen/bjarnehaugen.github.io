            ...
            <main className="mainContent">
                ...
                <div className="aboutMeRow">
                    <div className="aboutMeText">
                        ...
                        <h1><span className="whiteText fontBebasNeue fontStyleNormal fontSizeXLarge">BJARNE</span> <span className="yellowText fontBebasNeue fontStyleNormal fontSizeXLarge">HAUGEN</span></h1>
